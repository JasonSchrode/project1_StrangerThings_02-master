...
$(function () {
	...
	var treeVido = document.getElementById("treeVideo").addEventListener('ended',treeVideoHandler,false);
	    ...
	    function treeVideoHandler(e) {
	        e.preventDefault();
	        $(".treeTrailer").fadeOut(1200);
	        $(".navigationHidden").fadeIn(3000);
	    };


 	// var treeVido = document.getElementById("treeVideo").addEventListener('timeupdate', function() { 
